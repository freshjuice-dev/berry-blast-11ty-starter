...
- You promise not to use our code to build a competing berry-themed website
...
- Claim you invented the color berry
...
- The berry will always be blasting
...
**TL;DR:** This is a **demo template** - placeholder text for demonstration purposes only. The source code is available on [GitHub](https://github.com/freshjuice-dev/berry-blast-11ty-starter). Replace this with your real terms of service before going live!
