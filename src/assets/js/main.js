...
document.addEventListener(
  ...
  () => {
    ...
    // Berry Blast console branding
    console.log(
      "%c Berry Blast %c 11ty Starter ",
      "background: linear-gradient(135deg, #7c3aed 0%, #6d28d9 100%); color: white; font-size: 16px; font-weight: bold; padding: 8px 12px; border-radius: 8px 0 0 8px;",
      "background: #18181b; color: #7c3aed; font-size: 16px; font-weight: bold; padding: 8px 12px; border-radius: 0 8px 8px 0;"
    );
    console.log(
